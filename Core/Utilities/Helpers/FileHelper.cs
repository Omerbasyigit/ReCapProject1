...
namespace Core.Utilities.Helpers
{
    public class FileHelper : IFileHelper
    {
        ...
        {
            if (file!=null)//file.Length=>Dosya uzunluğunu bayt olarak alır. burada Dosya gönderil mi gönderilmemiş diye test işlemi yapıldı.
            {
            ...
            else
            {
                ...
                using (FileStream fileStream1=File.OpenRead(root+filePath))
                {
                    fileStream1.Flush();
                    return filePath;
                }
